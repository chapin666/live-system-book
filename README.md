...
| **项目4** | [采集与预览工具](project-04/) | 整合Ch10-14，实现专业级采集预览工具 |
| Ch15 | [美颜与滤镜](chapter-15/) | GPU图像处理、磨皮、美白、滤镜链设计 |
| Ch16 | [主播端架构](chapter-16/) | Pipeline架构、线程模型、音视频同步 |
| **项目5** | [完整主播端](project-05/) | 可开播的完整主播工具 |
...
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
│ Part 3: 实时连麦 (2-3个月) 📝 计划中                            │
│ Ch17-18 → 项目6 → Ch19-20 → 项目7 → Ch21-22 → 项目8          │
│ 成果: WebRTC多人会议系统                                        │
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
│ Part 4: 服务端架构 (1.5-2个月) 📝 计划中                        │
│ Ch23-24 → 项目9 → Ch25 → 项目10                                │
│ 成果: 生产级服务端（SFU/MCU/录制）                              │
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
│ Part 5: 生产部署 (0.5-1个月) 📝 计划中                          │
│ Ch26-28 → Ch29-30 → 项目11                                     │
│ 成果: Docker/K8s完整运维体系                                    │
└─────────────────────────────────────────────────────────────────┘
```

**预计总时间**：8-11 个月（Part 1+2 需 4-5 个月）
