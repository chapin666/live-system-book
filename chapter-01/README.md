...
```mermaid
flowchart TB
    subgraph Y平面[Y平面 亮度全采样]
        Y1[Y] --> Y2[Y] --> Y3[Y] --> Y4[Y]
        Y5[Y] --> Y6[Y] --> Y7[Y] --> Y8[Y]
    end
    
    subgraph UV平面[U/V平面 色度1/4采样]
        U1[U] --> U2[U]
        V1[V] --> V2[V]
    end
    ...
    style Y平面 fill:#e8f5e9,stroke:#388e3c
    style UV平面 fill:#fff9c4,stroke:#f9a825
```

> **说明**：4 个 Y 共享 1 个 U 和 1 个 V，数据量 = 4 + 1 + 1 = 6 字节/4像素 = 1.5 字节/像素，相比 RGB（3 字节/像素）节省 50%
